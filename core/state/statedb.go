...
// Convert a string to byte slice and append it to the given slice
func subPath(path []byte, s string) []byte {
	return append(path, []byte(s)...)
}

const balancePath = "balance"
const noncePath = "nonce"
const codePath = "code"
const codeSizePath = "codesize"
const codeHashPath = "codehash"
const suicidePath = "suicide"
...
func (s *StateDB) Version() Version {
	return Version{
		TxnIndex:    s.txIndex,
...
func (s *StateDB) GetCodeSize(addr common.Address) int {
	...
	return MVRead(s, subPath(addr.Bytes(), codeSizePath), 0, func(s *StateDB) int {
		stateObject := s.getStateObject(addr)
		if stateObject != nil {
...
func (s *StateDB) GetCodeHash(addr common.Address) common.Hash {
	...
	return MVRead(s, subPath(addr.Bytes(), codeHashPath), common.Hash{}, func(s *StateDB) common.Hash {
		stateObject := s.getStateObject(addr)
		if stateObject == nil {
			return common.Hash{}
		}
